...
const TreasuryProjectDetail = () => {
  ...
  return (
    <main className="bg-[#02080B]">
      ...
      >
        <div className="flex justify-between flex-col lg:flex-row md:flex-row items-center px-8 lg:px-40 md:px-40 h-[100vh]">
          <div className="lg:w-[50%] md:w-[50%] w-[100%] h-full mt-3 mx-auto text-center lg:px-0 md:px-0 ">
            {organization.map(
              (info) =>
